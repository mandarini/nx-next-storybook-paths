...
- `npx storybook@latest automigrate --config-dir apps/next-app/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir apps/react-vite/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir apps/react-webpack/.storybook --renderer undefined`
